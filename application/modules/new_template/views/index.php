...
<body>
                ...
                <div class="header-menu"> 
                    <div class="header-left">
                        ...
                        <div class="dropdown for-message">
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><img alt="avatar" src="<?php echo base_url('new_images/avatar/1.jpg'); ?>"></span>
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><img alt="avatar" src="<?php echo base_url('new_images/avatar/2.jpg'); ?>"></span>
                                    <div class="message media-body">
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><img alt="avatar" src="<?php echo base_url('new_images/avatar/3.jpg'); ?>"></span>
                                    <div class="message media-body">
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><img alt="avatar" src="<?php echo base_url('new_images/avatar/4.jpg'); ?>"></span>
                                    <div class="message media-body">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="<?php echo base_url('new_images/admin.jpg'); ?>" alt="User Avatar">
                        </a>
    ...
    <script src="<?php echo base_url('new_assets/js/plugins.js'); ?>"></script>
    <script src="<?php echo base_url('new_assets/js/main.js'); ?>"></script>

    <script src="<?php echo base_url('new_assets/js/lib/chart-js/Chart.bundle.js'); ?>"></script>


    <!--Chartist Chart-->
    <script src="<?php echo base_url('new_assets/js/lib/chartist/chartist.min.js'); ?>"></script>
    <script src="<?php echo base_url('new_assets/js/lib/chartist/chartist-plugin-legend.js'); ?>"></script> 

    
    <script src="<?php echo base_url('new_assets/js/lib/flot-chart/jquery.flot.js'); ?>"></script>
    <script src="<?php echo base_url('new_assets/js/lib/flot-chart/jquery.flot.pie.js'); ?>"></script>
    <script src="<?php echo base_url('new_assets/js/lib/flot-chart/jquery.flot.spline.js'); ?>"></script>


    <script src="<?php echo base_url('new_assets/weather/js/jquery.simpleWeather.min.js'); ?>"></script>
    <script src="<?php echo base_url('new_assets/weather/js/weather-init.js'); ?>"></script>


    <script src="<?php echo base_url('new_assets/js/lib/moment/moment.js'); ?>"></script>
    <script src="<?php echo base_url('new_assets/calendar/fullcalendar.min.js'); ?>"></script>
    <script src="<?php echo base_url('new_assets/calendar/fullcalendar-init.js'); ?>"></script>
