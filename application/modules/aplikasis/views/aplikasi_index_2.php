...
<div class="card">
    ...
    <div class="card-body">
        ...
        <button class="btn btn-success" onclick="window.location.href='<?php echo base_url('aplikasis/tambah'); ?>'"><i class="fa fa-plus-circle"></i> Tambah Data</button>
...
<script type="text/javascript">
    ...
    //data table load setting
        ...
        table = $("#datatable-aplikasi").dataTable({
            ...
            serverSide: true,
            "ajax": {
                "url": '<?php echo site_url('aplikasis/get_product_json'); ?>',
                "type": "POST"
            },
            //Set column definition initialisation properties.
            "columns": [
                {"data": "apliaksi_id",width:170},
                {"data": "aplikasi_kode",width:170},
                {"data": "nama",width:100},
                {"data": "barang_nama",width:170},
                {"data": "tenor",width:100},
                {"data": "dp",width:100, render: $.fn.dataTable.render.number(',', '.', '')},                        
                {"data": "angsuran",width:100, render: $.fn.dataTable.render.number(',', '.', '')},
